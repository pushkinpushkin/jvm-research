...
|---|---|---|---|
| `hotspot-work` | HotSpot / BellSoft Liberica | `docker-hub.binary.alfabank.ru/bellsoft/liberica-openjre-alpine:21.0.11-11` | рабочий baseline, максимально близкий к микросервисам |
